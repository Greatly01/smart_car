...
imwrite(A.cdata,'C:\Users\mingh\Desktop\MATLAB仿真\路径规划-路径跟踪控制\全局\第13讲双向RRT\data.png'); % save it as temporary map on computer
re_image = imread('C:\Users\mingh\Desktop\MATLAB仿真\路径规划-路径跟踪控制\全局\第13讲双向RRT\data.png');
