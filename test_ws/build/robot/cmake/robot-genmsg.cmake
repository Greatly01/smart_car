...
message(STATUS "robot: 0 messages, 1 services")
...
get_filename_component(_filename "/home/demo/test_ws/src/robot/srv/TransportRequest.srv" NAME_WE)
add_custom_target(_robot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot" "/home/demo/test_ws/src/robot/srv/TransportRequest.srv" ""
)
...
_generate_srv_cpp(robot
  "/home/demo/test_ws/src/robot/srv/TransportRequest.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot\")")
  # install generated code
  install(
