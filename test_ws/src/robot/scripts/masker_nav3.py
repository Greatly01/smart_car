...
if __name__ == '__main__':
    try:
        ...
        text_infos = [
            ('A', (3.41, -0.2, 0.5), 0.5, (0.0, 1.0, 0.0, 1.0)),  # 绿色A
            ('B', (0.2, -3.75, 0.5), 0.5, (1.0, 0.0, 0.0, 1.0)),  # 红色B

            ('C', (4.32, -2.2, 0.5), 0.5, (0.0, 0.0, 1.0, 1.0)),  # 蓝色C
            ('D', (4.62, -0.11, 0.5), 0.5, (1.0, 1.0, 0.0, 1.0)), # 黄色D
            ('Wait', (0.33, -1.3, 0.5), 0.4, (0.0, 1.0, 1.0, 1.0)),  # 青色
            ('Camp', (0.3, -2.4, 0.5), 0.4, (1.0, 1.0, 1.0, 1.0)),  # 白色
        ]
