...
if __name__ == '__main__':
    try:
        ...
        text_infos = [
            ('A', (-0.36, -1.7, 0.5), 0.7, (1.0, 0.0, 0.0, 1.0)),  # 红色A
            ('B', (-0.95, 3.49, 0.5), 0.7, (0.0, 1.0, 0.0, 1.0)),  # 绿色B
            ('C', (-1.04, 8.21, 0.5), 0.7, (0.0, 0.0, 1.0, 1.0)),  # 蓝色C
            ('D', (3.97, 5.22, 0.5), 0.7, (1.0, 1.0, 0.0, 1.0)), # 黄色D
            ('Wait', (0.98, 0.123, 0.5), 0.5, (0.0, 1.0, 1.0, 1.0)),  # 青色
            ('Camp', (1.03,-1.3, 0.5), 0.5, (1.0, 1.0, 1.0, 1.0)),  #白色
        ]
