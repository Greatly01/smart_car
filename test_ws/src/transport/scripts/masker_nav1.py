...
if __name__ == '__main__':
    try:
        ...
        text_infos = [
            ('A', (2.68, 1.35, 0.5), 0.5, (0.0, 1.0, 0.0, 1.0)),  # 绿色A
            ('B', (1.22, 1.35, 0.5), 0.5, (1.0, 0.0, 0.0, 1.0)),  # 红色B

            ('C', (2.66,3.4, 0.5), 0.5, (0.0, 0.0, 1.0, 1.0)),  # 蓝色C
            ('D', (1.06, 3.4, 0.5), 0.5, (1.0, 1.0, 0.0, 1.0)), # 黄色D
            ('Wait', (0.34, 0.03, 0.5), 0.3, (1.0, 1.0, 0.0, 1.0)),  
            ('Camp', (-0.0005, 0.06, 0.5), 0.3, (1.0, 1.0, 0.0, 1.0)),  
        ]
