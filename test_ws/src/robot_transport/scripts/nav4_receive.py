...
class RobotTransportSystem:
    ...
    def _load_waypoints(self):
        ...
        return [
            {
                "position": {"x": 0.05244851112365723, "y": -0.024779319763183594, "z": 0.0},
                "orientation": {"x": 0.0, "y": 0.0, "z": 0.7078502549658384, "w": 0.7063625248728853}
            },#wait-0
            {
                "position": {"x": 7.255318641662598, "y": 1.0749430656433105, "z": 0.0},
                "orientation": {"x": 0.0, "y": 0.0, "z": -0.699286739901431, "w": 0.7148412798642986}   
            },#A-1
            {
                "position": {"x": 3.3299288749694824, "y": 4.324728012084961, "z": 0.0},
                "orientation": {"x": 0.0, "y": 0.0, "z": -0.7150747243927732, "w": 0.6990480230532087}
            },#B-2
            {
                "position": {"x": 3.055140733718872, "y": 6.893378257751465, "z": 0.0},
                "orientation": {"x": 0.0, "y": 0.0, "z": 0.9564763299633579, "w": 0.29180992138689504}
            },#C-3
            {
                "position": {"x": -0.49414515495300293, "y": 4.74561882019043, "z": 0.0},
                "orientation": {"x": 0.0, "y": 0.0, "z": -0.708013593686086, "w": 0.706198804272362}
            },#D-4
            {
                "position": {"x": -1.6982660293579102, "y": -0.2327110767364502, "z": 0.0},
                "orientation": {"x": 0.0, "y": 0.0, "z": 0.6940848560827263, "w": 0.7198931952426145}
            },#camp-5
        ]
    ...
    def _load_mission_config(self):
        ...
        return {
            'A': {
                ...
                'actions': {
                    0: {'delay': 0, 'message': "任务进度：任务完成,等待下一次任务指令"},
                    1: {'delay': 3, 'message': "任务进度：到达战区A,已经完成接收伤员任务"},
                    5: {'delay': 3, 'message': "任务进度：到达我方营地,已完成放置伤员任务"},
                },
                'special_points': {  
                    0: 1,  # 第1次到达0点触发
                    1: 1,
            ...
            'B': {
                ...
                'actions': {
                    0: {'delay': 0, 'message': "任务进度：任务完成,等待下一次任务指令"},
                    2: {'delay': 3, 'message': "任务进度：到达战区B,已经完成接收伤员任务"},
                    5: {'delay': 3, 'message': "任务进度：到达我方营地,已完成放置伤员任务"},
                },
                'special_points': {
                    0: 1,  
            ...
            'C': {
                ...
                'actions': {
                    0: {'delay': 0, 'message': "任务进度：任务完成,等待下一次任务指令"},
                    3: {'delay': 3, 'message': "任务进度：到达战区C,已经完成接收伤员任务"},
                    5: {'delay': 3, 'message': "任务进度：到达我方营地,已完成放置伤员任务"},
                },
                'special_points': {
                    0: 1,
            ...
            'D': {
                ...
                'actions': {
                    0: {'delay': 0, 'message': "任务进度：任务完成,等待下一次任务指令"},
                    4: {'delay': 3, 'message': "任务进度：到达战区D,已经完成接收伤员任务"},
                    5: {'delay': 3, 'message': "任务进度：到达我方营地,已完成放置伤员任务"},
                },
                'special_points': {
                    0: 1,
