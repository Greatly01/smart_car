...
if __name__ == '__main__':
    try:
        ...
        text_infos = [
            ('A', (7.26, 1.08, 0.5), 0.5, (0.0, 1.0, 0.0, 1.0)),  # 绿色A
            ('B', (3.33, 4.32, 0.5), 0.5, (1.0, 0.0, 0.0, 1.0)),  # 红色B

            ('C', (3.06, 6.9, 0.5), 0.5, (0.0, 0.0, 1.0, 1.0)),  # 蓝色C
            ('D', (-0.5, 4.75, 0.5), 0.5, (1.0, 1.0, 0.0, 1.0)), # 黄色D
            ('Wait', (0.052, -0.024, 0.5), 0.4, (0.0, 1.0, 1.0, 1.0)),  # 青色
            ('Camp', (-1.7, -0.23, 0.5), 0.4, (1.0, 1.0, 1.0, 1.0)),  # 白色
        ]
