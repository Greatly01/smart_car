...
if("TRUE" STREQUAL "TRUE")
  set(wpb_home_behaviors_SOURCE_PREFIX /home/demo/test_ws/src/wpb_home/wpb_home_behaviors)
  set(wpb_home_behaviors_DEVEL_PREFIX /home/demo/test_ws/devel)
  ...
  set(wpb_home_behaviors_INSTALL_PREFIX /home/demo/test_ws/install)
...
if(NOT "/home/demo/test_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'wpb_home_behaviors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/demo/test_ws/src/wpb_home/wpb_home_behaviors/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT wpb_home_behaviors_NUM_DUMMY_TARGETS)
      set(wpb_home_behaviors_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::wpb_home_behaviors::wrapped-linker-option${wpb_home_behaviors_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR wpb_home_behaviors_NUM_DUMMY_TARGETS "${wpb_home_behaviors_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::wpb_home_behaviors::wrapped-linker-option${wpb_home_behaviors_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND wpb_home_behaviors_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(wpb_home_behaviors_EXPORTED_TARGETS ${${wpb_home_behaviors_dep}_EXPORTED_TARGETS})
endforeach()
