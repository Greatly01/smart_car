...
(cl:defmethod cl:initialize-instance :after ((m <TransportRequest-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TransportRequest-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot-srv:<TransportRequest-request> is deprecated: use robot-srv:TransportRequest-request instead.")))

(cl:ensure-generic-function 'target-val :lambda-list '(m))
(cl:defmethod target-val ((m <TransportRequest-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot-srv:target-val is deprecated.  Use robot-srv:target instead.")
  (target m))
...
(cl:defmethod cl:initialize-instance :after ((m <TransportRequest-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TransportRequest-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot-srv:<TransportRequest-response> is deprecated: use robot-srv:TransportRequest-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <TransportRequest-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot-srv:success-val is deprecated.  Use robot-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <TransportRequest-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot-srv:message-val is deprecated.  Use robot-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TransportRequest-response>)))
  ...
  "robot/TransportRequestResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TransportRequest-response)))
  "Returns string type for a service object of type 'TransportRequest-response"
  "robot/TransportRequestResponse")
