...
(cl:defmethod cl:initialize-instance :after ((m <TransportRequest-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TransportRequest-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name transport-srv:<TransportRequest-request> is deprecated: use transport-srv:TransportRequest-request instead.")))

(cl:ensure-generic-function 'target-val :lambda-list '(m))
(cl:defmethod target-val ((m <TransportRequest-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader transport-srv:target-val is deprecated.  Use transport-srv:target instead.")
  (target m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TransportRequest-request>)))
  ...
  "transport/TransportRequestRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TransportRequest-request)))
  "Returns string type for a service object of type 'TransportRequest-request"
  "transport/TransportRequestRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TransportRequest-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TransportRequest-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name transport-srv:<TransportRequest-response> is deprecated: use transport-srv:TransportRequest-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <TransportRequest-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader transport-srv:success-val is deprecated.  Use transport-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <TransportRequest-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader transport-srv:message-val is deprecated.  Use transport-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TransportRequest-response>)))
  ...
  "transport/TransportRequestResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TransportRequest-response)))
  "Returns string type for a service object of type 'TransportRequest-response"
  "transport/TransportRequestResponse")
